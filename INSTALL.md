...
**Ohne `v`.** Der Git-Tag heißt `v1.1.5`, das Image-Schild aber `1.1.5` — das
Präfix wird beim Veröffentlichen abgeschnitten. `IMAGE_TAG=v1.1.5` führt zu
`manifest unknown`. Verfügbar sind `1.1.5`, `1.1` (jeweils die neueste 1.1.x)
und `latest`.

### Umstieg auf 1.1.5 — zwei einmalige Handgriffe
